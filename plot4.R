getPlot4<- function(pathToFile){
  ...
  plot(x$Global_active_power, col="black", main="Global Active Power", type="l", ylab="Global Active power(kilowatts)", xlab="", axes=FALSE, frame=TRUE)
  axis(1, c(0,1500, 2900), c("thu", "fri", "sat"))
  axis(2, c(0,2,4,6), c("0","2","4","6"))
  
  with(x, plot(x$Voltage,  type="l", ylab="Voltage", xlab="datetime", axes=FALSE, frame=TRUE))
  axis(1, c(0,1500, 2900), c("thu", "fri", "sat"))
  ...
  plot(x$Global_reactive_power, col="black", main="Global Active Power", type="l", ylab="Global Active power(kilowatts)", xlab="datetime", axes=FALSE, frame=TRUE)
  axis(1, c(0,1500, 2900), c("thu", "fri", "sat"))
